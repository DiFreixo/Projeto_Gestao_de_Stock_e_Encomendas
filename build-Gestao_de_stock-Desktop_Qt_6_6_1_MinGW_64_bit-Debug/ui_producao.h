...
public:
    ...
    void setupUi(QWidget *Producao)
    {
        ...
        page1_ListarOPs = new QWidget();
        page1_ListarOPs->setObjectName("page1_ListarOPs");
        label = new QLabel(page1_ListarOPs);
        ...
        btnInicio_producao = new QPushButton(page1_ListarOPs);
...
"	border-radius: 5px;"));
        ...
        btnNovo_OP = new QPushButton(page1_ListarOPs);
...
"	border-radius: 5px;"));
        ...
        tableWidget_OrdemProd = new QTableWidget(page1_ListarOPs);
        ...
        groupBox = new QGroupBox(page1_ListarOPs);
...
"background-color: rgb(196, 196, 196);"));
        ...
        stackedWidget->addWidget(page1_ListarOPs);
        page2_RegistarOPs = new QWidget();
        page2_RegistarOPs->setObjectName("page2_RegistarOPs");
        label_8 = new QLabel(page2_RegistarOPs);
        label_8->setObjectName("label_8");
        label_8->setGeometry(QRect(150, 30, 711, 31));
        label_8->setFont(font);
        label_8->setStyleSheet(QString::fromUtf8("color: #004b23;"));
        label_8->setAlignment(Qt::AlignCenter);
        btnVoltar_producao = new QPushButton(page2_RegistarOPs);
...
"	border-radius: 5px;"));
        ...
        btnCancelar = new QPushButton(page2_RegistarOPs);
...
"	border-radius: 5px;"));
        ...
        txtRegisto = new QLineEdit(page2_RegistarOPs);
...
""));
        ...
        txtCodigo = new QLineEdit(page2_RegistarOPs);
        ...
        btnEliminar = new QPushButton(page2_RegistarOPs);
...
"	border-radius: 5px;"));
        ...
        label_10 = new QLabel(page2_RegistarOPs);
        label_10->setObjectName("label_10");
        label_10->setGeometry(QRect(180, 150, 141, 16));
        txtDataCriacao = new QLineEdit(page2_RegistarOPs);
        ...
        label_9 = new QLabel(page2_RegistarOPs);
        label_9->setObjectName("label_9");
        label_9->setGeometry(QRect(30, 150, 81, 16));
        label_11 = new QLabel(page2_RegistarOPs);
        label_11->setObjectName("label_11");
        label_11->setGeometry(QRect(30, 280, 191, 16));
        label_18 = new QLabel(page2_RegistarOPs);
        label_18->setObjectName("label_18");
        label_18->setGeometry(QRect(390, 280, 111, 16));
        txtQtdTotal = new QLineEdit(page2_RegistarOPs);
        ...
        label_43 = new QLabel(page2_RegistarOPs);
        label_43->setObjectName("label_43");
        label_43->setGeometry(QRect(150, 360, 51, 16));
        btnGuardar = new QPushButton(page2_RegistarOPs);
...
"	border-radius: 5px;"));
        ...
        cmbNrEncomenda = new QComboBox(page2_RegistarOPs);
        ...
        txtDataProducao = new QLineEdit(page2_RegistarOPs);
        ...
        label_19 = new QLabel(page2_RegistarOPs);
        label_19->setObjectName("label_19");
        label_19->setGeometry(QRect(390, 340, 111, 16));
        label_52 = new QLabel(page2_RegistarOPs);
        label_52->setObjectName("label_52");
        label_52->setGeometry(QRect(540, 150, 111, 16));
        txtStatusOP = new QLineEdit(page2_RegistarOPs);
        ...
        tableWidget_Produtos = new QTableWidget(page2_RegistarOPs);
        ...
        btnAdLinha = new QPushButton(page2_RegistarOPs);
        ...
        btnEliminaLinha = new QPushButton(page2_RegistarOPs);
        ...
        lblErro = new QLabel(page2_RegistarOPs);
        lblErro->setObjectName("lblErro");
        lblErro->setGeometry(QRect(610, 15, 371, 21));
        label_12 = new QLabel(page2_RegistarOPs);
        label_12->setObjectName("label_12");
        label_12->setGeometry(QRect(30, 220, 91, 16));
        dateEdit = new QDateEdit(page2_RegistarOPs);
        ...
        txtCliente = new QLineEdit(page2_RegistarOPs);
        ...
        btnProducao = new QPushButton(page2_RegistarOPs);
...
"	border-style: outset;\n"
"	border-radius: 1px;"));
        btnFechar = new QPushButton(page2_RegistarOPs);
...
"	border-style: outset;\n"
"	border-radius: 1px;"));
        label_20 = new QLabel(page2_RegistarOPs);
        label_20->setObjectName("label_20");
        label_20->setGeometry(QRect(550, 340, 111, 16));
        stackedWidget->addWidget(page2_RegistarOPs);
    ...
    void retranslateUi(QWidget *Producao)
    {
        ...
        label_52->setText(QCoreApplication::translate("Producao", "Estado OP", nullptr));
